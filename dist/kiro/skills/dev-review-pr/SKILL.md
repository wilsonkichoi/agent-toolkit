...
Read first: `.claude/dev.md` (config) and the plugin's `references/tracker.md` — on Claude Code
...
all - `references/tracker.md` "Secondary intake channel"): there is no packet. Gather instead the PR diff +
