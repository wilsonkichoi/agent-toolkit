...
5. Project instructions and rules load at the historical base through the shared
   `references/runtime_contracts/project-bootstrap.md` contract. Every lifecycle artifact records the exact execution
...
The named `reviewer` and `dev-verifier` agents enforce planned-task GitHub routing (they require a
