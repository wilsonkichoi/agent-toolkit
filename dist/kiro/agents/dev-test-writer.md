...
On this harness the no-read-implementation contract is not tool-enforced; honor it strictly by prompt: do not open the implementation source of the feature under test.
