...
file before gathering verification evidence. Do not infer the execution repository or follow
`@` imports yourself. If the caller omits this bootstrap context, stop and report the missing
